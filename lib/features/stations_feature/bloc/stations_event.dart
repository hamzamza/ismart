...
class ChangeingPageEvent extends StationsEvent {
  final int page;
  const ChangeingPageEvent({required this.page});
}

class ChangePageDuration extends StationsEvent {
  final bool charging;
  const ChangePageDuration({required this.charging});
}
